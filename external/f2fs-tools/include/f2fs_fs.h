...
struct f2fs_super_block {
	...
	__u8 reserved[177];		/* valid reserved region */
	__u8 api_level;			/* android api level */
	__le64 backupmeta_blkaddr __attribute__((packed));
					/* backup metadata offset for fast resize*/
